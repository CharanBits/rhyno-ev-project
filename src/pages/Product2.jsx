...
import wood95Image from "../assets/bikespng/wood95.png";
...
const Product2 = () => {
  ...
  return (
    <ProductPage>
      <ProductTitle>Rhyno SE03</ProductTitle>
      <ProductImage src={images[color]} alt={`${color} bike`} />

      <div>
        <RedButton onClick={() => setColor("gold")}>Golden</RedButton>
        <BlueButton onClick={() => setColor("red")}>Red</BlueButton>
        <BlackButton onClick={() => setColor("wood")}>Brown</BlackButton>
      </div>
        ...
        <Table className="table table-dark table-hover">
          ...
          <tbody>
            ...
            <TableRow>
              ...
              <TableData data-label="Rhyno SE03 Lite">55 km/h</TableData>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableData data-label="Rhyno SE03 Lite">150 km</TableData>
            </TableRow>
            <TableRow>
              <TableData data-label="Specification">Max range (@45km/h)</TableData>
              <TableData data-label="Rhyno SE03 Lite">110 km</TableData>
            </TableRow>
            <TableRow>
