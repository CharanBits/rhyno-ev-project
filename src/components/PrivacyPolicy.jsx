...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy">
      <h1 className='privacy'>Privacy Policy for RHYNO EV</h1>
      <p className='privacy_P'>
        This is the Privacy Policy for RHYNO EV, accessible from https://www.rhyno.in.
      </p>

      <h2 className='small'>What Are Cookies</h2>
      <p className ='privacy_P'>
      ...
      <p className ='privacy_P'>
        For more general information on cookies see the related web article on Cookies.
      </p>

      <h2 className='small'>How We Use Cookies</h2>
      <p className ='privacy_P'>
        We use cookies for a variety of reasons detailed below. Unfortunately, in most cases there are no industry standard options for disabling cookies without completely disabling the functionality and features they add to this site. It is recommended that you leave on all cookies if you are not sure whether you need them or not in case they are used to provide a service that you use.
      </p>

      <h2 className='small'>Disabling Cookies</h2>
      <p className ='privacy_P'>
        You can prevent the setting of cookies by adjusting the settings on your browser (see your browser Help for how to do this). Be aware that disabling cookies will affect the functionality of this and many other websites that you visit. Disabling cookies will usually result in also disabling certain functionality and features of this site. Therefore it is recommended that you do not disable cookies.
      </p>

      <h2 className='small'>The Cookies We Set</h2>
      <h3 className='side'>Account related cookies</h3>
      <p className ='privacy_P'>
        If you create an account with us then we will use cookies for the management of the signup process and general administration. These cookies will usually be deleted when you log out however in some cases they may remain afterwards to remember your site preferences when logged out.
      </p>

      <h3 className='side'>Email newsletters related cookies</h3>
      <p className ='privacy_P'>
        This site offers newsletter or email subscription services and cookies may be used to remember if you are already registered and whether to show certain notifications which might only be valid to subscribed/unsubscribed users.
      </p>

      <h3 className='side'>Orders processing related cookies</h3>
      <p className ='privacy_P'>
        This site offers e-commerce or payment facilities and some cookies are essential to ensure that your order is remembered between pages so that we can process it properly.
      </p>

      <h3 className='side'>Forms related cookies</h3>
      <p className ='privacy_P'>
        When you submit data through a form such as those found on contact pages or comment forms cookies may be set to remember your user details for future correspondence.
      </p>

      <h3 className='side'>Site preferences cookies</h3>
      <p className ='privacy_P'>
        In order to provide you with a great experience on this site we provide the functionality to set your preferences for how this site runs when you use it. In order to remember your preferences we need to set cookies so that this information can be called whenever you interact with a page is affected by your preferences.
      </p>

      <h2 className='small'>Third Party Cookies</h2>
      <p className ='privacy_P'>
      ...
      <h2 className='small'>Information We Collect</h2>
      <p className ='privacy_P'>
        In order to provide you better experience and better function usability on site, you would require to provide your basic details with us. These details will be protected, but in some cases, may be shared with authorised service providers for functions like storage and processing payments. Please ensure that the details provided by you are accurate and up to date.
      </p>
      <p className ='privacy_P'>
      ...
      <h2 className='small'>Information We Share</h2>
      <p className ='privacy_P'>
      ...
      <ul>
        <li>Help detect and prevent identity theft, fraud and other potentially illegal acts;</li>
      </ul>

      <h2 className='small'>Change in Privacy Policy</h2>
      <p className ='privacy_P'>
      ...
      <h2 className='small'>Disclaimer</h2>
      <p className ='privacy_P'>
      ...
      <p className="email-link">
        Email: <a href="mailto:info@rhyno.in">info@rhyno.in</a>
      </p>
